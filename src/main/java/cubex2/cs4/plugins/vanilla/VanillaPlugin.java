...
public class VanillaPlugin implements CustomStuffPlugin
{
    ...
    public void registerContent(ContentRegistry registry)
    {
        ...
        registry.registerDeserializer(ItemModuleSupplier.class, new ItemModuleSupplierDeserializer(CustomStuff4.contentRegistry));
        ...
        registry.registerContentType("block:door", ContentBlockDoor.class);
        registry.registerContentType("block:slidingDoor", ContentBlockSlidingDoor.class);
        ...
        registry.registerItemModule("inventory", ItemModuleInventory.Supplier.class);
